...
def lesson_terrain(configfile : String)
  ...
  CrystGLFW.run do
    ...
    entities << Entity.new(terrain_model1,GLM::Vec3.new(-2,0,0),scene.model_rotation("terrain"),scene.model_scale("terrain"))
    #entities << Entity.new(terrain_model1,GLM::Vec3.new(-1,0,0),scene.model_rotation("terrain"),scene.model_scale("terrain"))

    #entities << Entity.new(terrain_model1,GLM::Vec3.new(0,0,-1),scene.model_rotation("terrain"),scene.model_scale("terrain"))
