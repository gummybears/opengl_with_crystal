...
def lesson(configfile : String)
  ...
  CrystGLFW.run do
    ...
    #
    fern_texture_atlas = ModelTexture.load("res/fern_texture_atlas.png")

    fern_model = TextureModel.new(Model.load(fern_data),fern_texture_atlas)
    fern_model.number_of_rows = 2
    ...
    1.upto(200) do |i|
      ...
      fern  = Entity.new(fern_model, random_texture_index,position,scene.model_rotation("fern"),scene.model_scale("fern"))
