...
class Game
  ...
  def setup_world_scene()
    ...
    #
    # try to position the lamp y coordinate
    # with the height of the lamp
    # to be precise need to know the height of the lamp
    #
    position2 = @config.light_position(2)
    lamp2.position.y = position2.y - 7

    position3 = @config.light_position(3)
    lamp3.position.y = position3.y - 7

    position4 = @config.light_position(4)
    lamp4.position.y = position4.y - 7
