...
class SkyBoxRenderer
  ...
  def render(camera : Camera, color : Color)
    ...
    @shader.load_fogcolor(color)

    @model.bind()

    #
    # could make the blend factor time dependant
    # and/or randomly choose which textures to display
    # etc.
    #
    bind_textures(0.5f32)
  ...
  #
  def bind_textures(blend_factor : Float32)
    ...
    @shader.load_blendfactor(blend_factor)
  end
